      ...
      <div class="container">
        ...
        >
          ...
          <li class="nav-item mb-md-0 mb-4 w-20" role="presentation">
            <button
              class="nav-link w-100 p-md-0"
              id="pills-archievedapp-tab"
              data-bs-toggle="pill"
              data-bs-target="#pills-archievedapp"
              type="button"
              role="tab"
              aria-controls="pills-archievedapp"
              aria-selected="false"
              @click="fetchArchivedAppointments"
            >
              <div class="border-top-nav position-relative mb-3">
                <i class="fas fa-circle position-absolute"></i>
              </div>
              <div class="text-dark mentor-head">
                {{ $t("appointment_log.label_5") }}
              </div>
            </button>
          </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
                    ...
                    >
                      ...
                      <tbody class="text-dark">
                        ...
                        <tr
                          ...
                          :key="appointment.id"
                        >
                          <td v-if="appointment.questions != null">
                          ...
                          <td v-if="appointment.is_paid == 0">
                            ...
                            {{
                              $t(
                                "appointment_log.tab.pending.column.unpaid_text"
                              )
                            }}
                          </td>
                        ...
                        <tr
                          v-if="
                            allPendingAppointmentsFilter.length == 0 && !loading
                          "
                        >
              ...
              <div class="col-md-12">
                <div class="bg-white px-2 py-lg-0 py-3">
                  <div class="row">
                    <div class="col-lg-4">
                      <div
                        class="p-3 py-2 d-flex align-items-center h-100"
                      ></div>
                    </div>
                      ...
                      <div class="p-3 py-2">
                        <div class="d-flex align-items-center h-100">
                          <div class="w-25">
                            <label
                              for="filter"
                              class="pe-2 text-primary fw-bold"
                              >Search:</label
                            >
                          </div>
                          <div class="w-100">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody class="text-dark">
                        ...
                        <tr
                          v-if="
                            allAcceptedAppointmentsFilter.length == 0 &&
                            !loading
                          "
                        >
                          <td colspan="9" class="text-center">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody class="text-dark">
                        ...
                        <tr
                          v-if="
                            allCancelledAppointmentsFilter.length == 0 &&
                            !loading
                          "
                        >
                          <td colspan="9" class="text-center">
                    ...
                    >
                      ...
                      <tbody class="text-dark">
                        ...
                        >
                          ...
                          <td class="w-275">
                            <a
                              @click="ArchiveAppointment(appointment.id)"
                              class="btn btn-primary mb-md-0 mb-2 btn-sm mt-1"
                              >{{ $t("appointment_log.archive") }}</a
                            >
                            <a
                              :href="`${
                                url +
                        ...
                        <tr
                          v-if="allAppointmentsFilter.length == 0 && !loading"
                        >
                          <td colspan="9" class="text-center">
                            No record found
                          </td>
          ...
          <div
            class="tab-pane fade"
            id="pills-archievedapp"
            role="tabpanel"
            aria-labelledby="pills-archievedapp-tab"
          >
            <div class="row">
              <div class="col-md-12">
                <div class="bg-white px-2 py-lg-0 py-3">
            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody class="text-dark">
                        ...
                        <tr
                          v-else
                          v-for="appointment in allArchivedAppointments"
                          :key="appointment.id"
                        >
                          <td v-if="appointment.questions != null">
                            <div class="wrap-ques ps-2">
                          ...
                          <td>
                            {{
                              $t(
                                "appointment_log.tab.pending.column.appointment_status.archived"
                              )
                            }}
                          </td>
                          <td class="w-275">
                            <a
                              @click="unArchiveAppointment(appointment.id)"
                              class="btn btn-primary mb-md-0 mb-2 btn-sm mt-1"
                              >{{ $t("appointment_log.un_archive") }}</a
                            >
                            <a
                              :href="`${
                                url +
                        ...
                        <tr
                          v-if="allArchivedAppointments.length == 0 && !loading"
                        >
                          <td colspan="9" class="text-center">
                            No record found
                          </td>
                ...
                >
                  <v-page
                    :total-row="allArchivedAppointments.length"
                    align="left"
                    v-model="current"
                    @page-change="allArchivedAppointmentsChange"
                    :page-size-menu="[10, 20, 30]"
                    v-if="!loading"
                  ></v-page>
                </div>
...
export default {
  ...
  methods: {
    ...
    allArchivedAppointmentsChange(pInfo) {},
    pendingAppointmentsChange(pInfo) {
      this.allPendingAppointmentsFilter.splice(
        0,
        this.allPendingAppointmentsFilter.length
      );
      let start = 0,
        end = 0;
      start = pInfo.pageSize * (pInfo.pageNumber - 1);
      end = start + pInfo.pageSize;
      if (end > this.allPendingAppointments.length)
        end = this.allPendingAppointments.length;
      for (let i = start; i < end; i++) {
        this.allPendingAppointmentsFilter.push(this.allPendingAppointments[i]);
      }
    },
    acceptedAppointmentsChange(pInfo) {
      this.allAcceptedAppointmentsFilter.splice(
        0,
        this.allAcceptedAppointmentsFilter.length
      );
      let start = 0,
        end = 0;
      start = pInfo.pageSize * (pInfo.pageNumber - 1);
      end = start + pInfo.pageSize;
      if (end > this.allAcceptedAppointments.length)
        end = this.allAcceptedAppointments.length;
      for (let i = start; i < end; i++) {
        this.allAcceptedAppointmentsFilter.push(
          this.allAcceptedAppointments[i]
        );
      }
    },
    cancelledAppointmentsChange(pInfo) {
      this.allCancelledAppointmentsFilter.splice(
        0,
        this.allCancelledAppointmentsFilter.length
      );
      let start = 0,
        end = 0;
      start = pInfo.pageSize * (pInfo.pageNumber - 1);
      end = start + pInfo.pageSize;
      if (end > this.allCancelledAppointments.length)
        end = this.allCancelledAppointments.length;
      for (let i = start; i < end; i++) {
        this.allCancelledAppointmentsFilter.push(
          this.allCancelledAppointments[i]
        );
      }
    },
    async fetchCancelledAppointments() {
      ...
      const res = await axios.get("/api/mentorAppointmentsStatusWise", {
        params,
      });
    ...
    async fetchArchivedAppointments() {
      this.loading = true;
      const params = {
        token: 123,
        mentor_id: this.User.user_id,
      };
      const res = await axios.get("/api/mentor/archieve-appointments", {
        params,
      });
      if (res.data && res.data.Status) {
        this.allArchivedAppointments = res.data.data.archiveAppointments.data;
        this.loading = false;
      }
    },
    async unArchiveAppointment(id) {
      this.loading = true;
      ...
      const res = await axios
        .post("/api/mentor/unarchieved-appointment", params)
        .then((res) => {
          if (res.data.Status) {
            this.loading = true;
            toast.success(res.data.msg);
            this.fetchArchivedAppointments();
            this.loading = false;
          }
          if (!res.data.Status) {
    ...
    refreshAppointments(id) {
      //     var tabs = document.getElementById('pills-compapp-tab');
      var index = this.allAppointmentsFilter.findIndex((x) => x.id === id);
      this.allAppointmentsFilter.splice(index, 1);
      var index = this.allAppointments.findIndex((x) => x.id === id);
    ...
    async ArchiveAppointment(id) {
      ...
      const res = await axios
        .post("/api/mentor/archieved-appointment", params)
        .then((res) => {
          if (res.data.Status) {
            this.loading = true;
            toast.success(res.data.msg);
            this.refreshAppointments(id);
            this.loading = false;
          }
          if (!res.data.Status) {
            toast.error("Something Went Worng..");
    ...
    async acceptAppointment(id) {
      var index = this.allPendingAppointmentsFilter.findIndex(
        (x) => x.id === id
      );
      var toast = this.$toasted;
      const params = {
