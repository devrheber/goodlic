          ...
          <div class="row">
            <div class="col-12 px-4 mb-4">
              <div class="row bg-img py-4 px-c border-8 pb-lg-4 pb-5">
                ...
                <div class="col-lg-2 col-md-6 mt-3 text-primary">
                  ...
                  <div class="custom-select">
                    <select
                      ...
                      v-on:change="fetchCities()"
                    >
                      <option value="" selected>
                        {{
                          $t("mentor.profile.general.place_holder.select_state")
                        }}
                      </option>
                      <option
                        :value="state.id"
                ...
                <div class="col-lg-2 mt-3 ps-lg-4">
                  ...
                  >
                    <i class="fa-solid fa-arrow-rotate-right pe-2 fs-20"></i>
                    <span class="border-white">Reset All</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div class="row h-100">
              ...
              >
                <div class="">
                  ...
                  <div
                    class="guider-info d-flex justify-content-center align-items-center"
                  >
                    <div
...
export default {
  ...
  methods: {
    checkLogin(mentor_id) {
      ...
      var menteeProfileCompleted = JSON.parse(
        localStorage.getItem("menteeProfileCompleted")
      );
      ...
      if (!User) {
        ...
        if (User.role == "Mentee" && menteeProfileCompleted) {
          window.location.href =
            this.url + "/appointment-schedule/" + mentor_id;
        } else if (User.role == "Mentor") {
          this.$toasted.error("Please Login as a User");
        } else {
          this.$toasted.error("Please complete your profile first");
          window.location.href = this.url + "/mentee-profile";
        }
      }
    },
    async fetchMentors() {
    ...
    async getRangeValue() {
      ...
      var max_value = value[1];
        ...
        async fetchStates() {
      var country_id = this.filters.country_id;
      const params = {
        token: 123,
  ...
  async fetchCities() {
      var state_id = this.filters.state_id;
      const params = {
        token: 123,
        state_id: state_id,
      };
  ...
  async created() {
    ...
    let state_id = searchParams.get("state_id");
