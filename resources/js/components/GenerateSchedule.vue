<template>
  <section class="mentor-profile">
    <div class="schedule-appointment container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="text-primary fw-bold mb-5 text-center">
            Generate Schedule
          </h2>
        </div>
      </div>
      <div class="row">
        <div class="col-xxl-2 col-lg-3 pe-lg-0">
          ...
          >
            ...
            <button
              class="nav-link active w-100 mb-2"
              id="v-pills-chat-tab"
              data-bs-toggle="pill"
              ...
              aria-selected="true"
              v-on:click="chnageAppointmentType(3)"
            >
              <i class="fa-solid fa-comment me-2"></i>
              Per chat Schedule
            </button>
            <button
              class="nav-link w-100 mb-2"
              id="v-pills-live-tab"
              data-bs-toggle="pill"
              ...
              aria-selected="true"
              v-on:click="chnageAppointmentType(6)"
            >
              <i class="fa-solid fa-comment me-2"></i>
              Per Live Schedule
            </button>
            <button
              ...
              aria-selected="false"
              v-on:click="chnageAppointmentType(2)"
            >
            ...
            <button
              ...
              aria-selected="false"
              v-on:click="chnageAppointmentType(1)"
            >
            ...
            <button
              class="nav-link w-100 mb-2"
              id="v-pills-visit-tab"
              data-bs-toggle="pill"
              data-bs-target="#v-pills-visit"
              type="button"
              role="tab"
              aria-controls="v-visit-settings"
              aria-selected="false"
              v-on:click="chnageAppointmentType(4)"
            >
            ...
            <button
              class="nav-link w-100 mb-2"
              id="v-pills-hvisit-tab"
              data-bs-toggle="pill"
              data-bs-target="#v-pills-hvisit"
              type="button"
              role="tab"
              aria-controls="v-visit-settings"
              aria-selected="false"
              v-on:click="chnageAppointmentType(5)"
            >
        ...
        <div class="col-xxl-10 col-lg-9 ps-lg-0">
          <div
            class="bg-white schedule-tabs p-4 pb-5 h-100 d-flex justify-content-center align-items-center"
          >
            <div class="tab-content w-100" id="v-pills-tabContent">
              <!-- live consultation content -->
              <div
              ...
              >
                ...
                <p class="schedule-desc">
                  You can set your consultancy fee for Live mode.
                </p>
                <h6 class="text-primary mt-3 mb-3 fw-bold">
                  Select Fee Charges for Live
                </h6>
                <div class="schedule-border p-3">
                  <input
                    type="number"
                    class="form-control border"
                    placeholder="Enter Live Fee"
                    v-model="live.fee"
                  />
                  <div class="position-relative mt-4">
                    <button
                      type="button"
                      v-on:click="updateLiveFee()"
                      class="btn btn-secondary text-white text-capitalize fw-bold position-absolute end-0"
                    >
                      Update Fee
                    </button>
                  </div>
              ...
              >
                ...
                <div class="schedule-border p-3">
                  <input
                    type="number"
                    class="form-control border"
                    placeholder="Enter Chat Fee"
                    v-model="chat.fee"
                  />
                  <div class="position-relative mt-4">
                    <button
                      type="button"
                      v-on:click="updateChatFee()"
                      class="btn btn-secondary text-white text-capitalize fw-bold position-absolute end-0"
                    >
                      Update Fee
                    </button>
              ...
              >
                ...
                <h6
                  class="text-primary mt-md-3 mb-3 mt-5 fw-bold"
                  v-if="showSlotPanel"
                >
                ...
                <div class="schedule-border p-3" v-if="showSlotPanel">
                  ...
                  <div class="position-relative mt-4">
                    <button
                      type="button"
                      class="btn btn-secondary text-white text-capitalize fw-bold position-absolute end-0 mr-custom"
                  ...
                  <div class="position-relative mt-4">
                    <button
                      type="button"
                      class="btn btn-primary text-capitalize fw-bold position-absolute end-0 px-md-4 px-2"
                ...
                <h6
                  class="text-primary mt-md-4 mt-5 fw-bold"
                  v-if="showSlotPanel"
                >
                  Generate slots
                </h6>
                <div v-if="showSlotPanel">
                  <div class="row">
                    <div
                      class="col-auto w-125"
                      v-for="time in timeSlotsHours"
                      :key="time.id"
                    >
                  ...
                  <button
                    type="button"
                    class="btn btn-secondary text-white text-capitalize fw-bold mt-4"
                  ...
                  <div class="row d-flex align-items-center h-100">
                    ...
                    <div class="col-md-6 col-lg-3 mt-2">
                      <input
                        type="number"
                        class="form-control border"
                        placeholder="Enter Audio Charges"
                        v-model="audioSlot.fee"
                      />
                    </div>
                    <div class="col-md-6 col-lg-2 mt-2">
                      <span>Select Days</span>
              ...
              >
                <h5 class="text-secondary">
                  <i class="fa-solid fa-laptop-house me-2 text-primary"></i>
                  Onsite Consultation Schedule
                </h5>
                <p class="schedule-desc">
                  You can create schedule whether, for how many days you will be
                  available in a week or in a month. You can set your fee
              ...
              >
                <h5 class="text-secondary">
                  <i class="fa-solid fa-home me-2 text-primary"></i> Home Visit
                  Schedule
                </h5>
                <p class="schedule-desc">
                  You can create schedule whether, for how many days you will be
                  available in a week or in a month. You can set your fee
                  charges, and available for home visit consultancy time in a
                  day.
                </p>
                <h6 class="text-primary mt-3 mb-3 fw-bold">
                  Select Day for your schedule
                  ...
                  <div class="row d-flex align-items-center h-100">
                    ...
                    <div class="col-md-6 col-lg-3 mt-2">
                      <input
                        type="text"
                        class="form-control border"
                        placeholder="Enter HomeVisit Charges"
                        v-model="homeVisitSlot.fee"
                      />
                    </div>
                    <div class="col-md-6 col-lg-2 mt-2">
                      <span>Select Days</span>
        ...
        <div class="col-md-12">
          <div class="bg-white generate-schedule border-0 mt-5 pb-4">
            ...
            <div v-if="mentorAllSchedules">
              <div
                class=""
                v-for="schedule in mentorAllSchedules"
                :key="schedule.id"
              >
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="row">
                        <div class="col-md-10">
                          <div class="row">
                            ...
                            <div class="col-auto">
                              <span class="text-dark fw-bold">Fee:</span
                              ><span class="ms-1"
                                >{{ currency_symbol }} {{ schedule.fee }}</span
                              >
                            </div>
                            <div class="col-auto">
                              <span class="text-dark fw-bold"
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <div class="row">
                        <div
                          class="col-auto w-125"
                          v-for="time in schedule.schedule_slots"
                          :key="time.id"
                        >
...
export default {
  props: ["url", "currency_symbol", "minimum_appointment_fee"],
  mixins: [loginMixin],
  data() {
    return {
      loading: true,
  ...
  methods: {
   ...
   async chnageAppointmentType(type) {
      this.appointment_id = type;
      this.mentorAvaiableDays();
    await this.getChatFee();
      this.timeSlots = [];
    ...
    async getChatFee() {
      ...
      if (res.data && res.data.Status) {
        if (this.appointment_id == 3 ) {
            this.chat.fee = res.data.data.chatFee;
        }
         if (this.appointment_id == 6 ) {
            this.live.fee = res.data.data.chatFee;
        }
      }
    },
    async updateChatFee() {
      ...
      if (this.chat.fee < this.minimum_appointment_fee) {
        this.$toasted.error(
          "Fee Cannot be less then " + this.minimum_appointment_fee
        );
      } else {
        const res = await axios
    ...
    async updateLiveFee() {
      ...
      if (this.live.fee < this.minimum_appointment_fee) {
        this.$toasted.error(
          "Fee Cannot be less then " + this.minimum_appointment_fee
        );
      } else {
  ...
  created() {
    ...
    this.getMentorSchedules();
    this.profileStatus();
    this.minimum_appointment_fee = parseInt(this.minimum_appointment_fee)
  },
  mounted() {
