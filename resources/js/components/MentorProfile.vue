      ...
      <div class="row mb-5">
        <div class="col-lg-2 col-md-3 col-6 w-11">
          <div class="profile-img-shape-sm">
            ...
            <div
              class="file-upload-div-sm p-0 d-flex justify-content-center align-items-center position-relative flex-column"
            >
              <img
                  ...
                  >
                    <div class="row">
                      ...
                      <div class="col-md-6 position-relative">
                        ...
                        <div class="col-md-6 position-relative">
                        <label for="" class="text-primary mb-2 mt-4">
                          {{ $t("mentor.profile.general.place_holder.email") }}
                        </label>
                        <input
                          type="text"
                        ...
                        >
                         ...
                         <div class="col-md-6 position-relative">
                        <label for="" class="text-primary mb-2 mt-4">
                          {{ $t("mentor.profile.general.place_holder.phone") }}
                        </label>
                        <input
                          type="text"
                      ...
                      <div class="col-md-6 position-relative">
                        <label for="" class="text-primary mb-2 mt-4">
                          {{ $t("mentor.profile.general.place_holder.state") }}
                        </label>
                        <div class="custom-select">
                          <select
                            class="form-select border"
                          ...
                          >
                            <option selected value="">
                              {{
                                $t(
                                  "mentor.profile.general.place_holder.select_state"
                                )
                              }}
                            </option>
                            <option
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                      <div class="modal-content border-0">
                        <div class="modal-body py-5">
                          <h3
                            class="modal-title text-primary px-md-4 fw-bold mb-4"
                          ...
                          >
                            <div class="row">
                              ...
                              <div class="col-md-12 position-relative">
                                ...
                                <div
                                  class="upload-btn-wrapper d-flex w-100 border p-1"
                                >
                                  <button
                                    class="h-100 me-3 btn btn-upload d-flex justify-content-center border-0 bg-muted text-dark py-2 px-3"
                                    style="padding: 12px"
                                  >
                                    <img
                              ...
                              >
                                <div class="mt-4">
                                  <button
                                    class="btn btn-upload d-flex align-items-end justify-content-center border-0 btn-secondary box-shadow-secondary text-white px-4"
                                    type="submit"
                                  >
                                    Add
                                  </button>
                              ...
                              >
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="mt-3">
                                      <button
                                        class="btn btn-upload w-100 border-0 btn-secondary box-shadow-secondary text-white px-4"
                                        v-on:click="addSkill"
                                        type="button"
                                        style="padding: 12px"
                                      >
