<template>
  <div class="agora-video-player" ref="player" :id="domId" v-if="appointment_type_id == 2 || appointment_type_id == 6"></div>
...
export default {
  ...
  mounted () {
    console.log('appointment_type_id',this.appointment_type_id);
