                ...
                <div class="col-md-6">
                  <p class="mb-0 text-white d-flex align-items-center">
                    {{ $t("wallet_log.current_wallet_balance") }}:<span
                      ...
                      >{{ currency_symbol }} {{ current_balance }}</span
                    >
                  </p>
                </div>
                <div class="col-md-6">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body form-group">
                <input
                  ...
                  :placeholder="
                    $t('wallet_log.withdraw_amount.placeholder.amount')
                  "
                />
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content border-0">
              <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="addModelLabel" style="color: white">
                  {{ $t("wallet_log.btn_label_topup") }}
                </h5>
                <button
                  type="button"
              ...
              <div v-if="!loading" class="modal-body form-group">
                ...
                <div class="col-md-12">
                  ...
                  <div class="payment-card mt-3">
                    <ul class="d-inline-flex flex-wrap ps-0" type="none">
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="payment_details.card_name"
              ...
              <div class="modal-footer">
                ...
                <button
                  ...
                  :disabled="paymentLoading || !recaptchaVerified"
                >
                  {{ $t("wallet_log.button.submit") }}
                </button>
              </div>
                ...
                <table class="table align-middle mb-0">
                  <tbody class="text-dark">
                    <tr>
                      ...
                      <td class="py-3">
                        {{ $t("wallet_log.column.amount") }}
                      </td>
                      <td class="py-3">
                        {{ $t("wallet_log.column.type") }}
                      </td>
                      <td class="py-3">
                        {{ $t("wallet_log.column.status") }}
                      </td>
                    </tr>
...
export default {
  ...
  methods: {
    async fetchCurrentBalance() {
      document.getElementById("add_ammount").click();
      this.payment_details.card_number = "";
      this.payment_details.card_name = "";
      this.payment_details.exp_month = "";
      this.payment_details.exp_year = "";
      this.payment_details.cvc = "";
      this.amount = "";
      this.jazzcash.mobile_no = "";
      this.jazzcash.cnic_digit = "";
