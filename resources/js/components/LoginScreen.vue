            ...
            axios
                ...
                .then((response) => {
                    if (response.data.Status) {
                        ...
                        let is_profile_completed = response.data.data.user.mentee.is_profile_completed;
                        let full_name =
                        ...
                        localStorage.setItem("menteeProfileCompleted", JSON.stringify(is_profile_completed));
                        toast.success(response.data.msg);
                        //Device token
      ...
      axios
        ...
        .then((response) => {
          if (response.data && response.data.Status == true) {
            ...
            localStorage.setItem("User", JSON.stringify(User));
            localStorage.setItem("menteeProfileCompleted", JSON.stringify(response.data.data.is_profile_completed));
            toast.success(response.data.msg);
