...
<br>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            <a href="{{route('admin.content_pages.list')}}"class="nav-link">
        ...
        {{-- @endpermission --}}
        {{-- @permission('about_us_page') --}}
        <li class="nav-item">
            <a href="{{route('admin.about_us_page.list')}}"class="nav-link">
        ...
        @permission('blogs')
          ...
          @permission('payment-configuration')
           <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="{{route('admin.email_templates.list')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Email Templates
                    {{-- <span class="right badge badge-danger">New</span> --}}
