                    ...
                    <div class="card-body">
                        <div class="form-group mt-3">
                          ...
                          <div class="form-group">
                            ...
                            @if ($detail->category_icon)
                                <img src="{{asset($detail->category_icon)}}"  height="200" width="200" alt=""><br><br>
                            @endif
                            <input type="file"  onchange="openFile(this)" class="form-control h-100" name="icon" placeholder="International Phone Number">
                          </div>
